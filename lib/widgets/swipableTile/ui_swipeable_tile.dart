...
/// Used by [UIProSwipeableTile.onSwiped].
typedef SwipedCallback = void Function(SwipeDirection direction);

/// Used by [UIProSwipeableTile.confirmSwipe].
...
class UIProSwipeableTile extends StatefulWidget {
  ...
  /// Similar to normal [UIProSwipeableTile] with additional card effet like,
  ...
  /// Similar to [UIProSwipeableTile.swipeToTrigger] with additional card effet like,
  /// rounded corner, padding and elevation.
  ///
  /// The [key] argument must not be null because [UIProSwipeableTile]s are commonly
  /// used in lists and removed from the list when swiped. Without keys, the
      ...
      assert(() {
        if (_resizeAnimation!.status != AnimationStatus.forward) {
          ...
          throw FlutterError.fromParts(<DiagnosticsNode>[
            ErrorSummary(
                'A swiped UIProSwipeableTile widget is still part of the tree.'),
            ErrorHint(
              'Make sure to implement the onSwiped handler and to immediately remove the UIProSwipeableTile '
