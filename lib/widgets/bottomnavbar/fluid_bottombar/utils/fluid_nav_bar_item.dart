...
/// fluid navigation bar widget according to [UIProFluidNavBarIcon] definition.
///
/// See also:
///
///  * [UIProFluidNavBar]
...
class UIProFluidNavBarItem extends StatefulWidget {
  ...
  final UIProFluidNavBarButtonTappedCallback onTap;
...
class _UIProFluidNavBarItemState extends State<UIProFluidNavBarItem>
  ...
  Widget build(context) {
    const ne = UIProFluidNavBarItem.nominalExtent;
