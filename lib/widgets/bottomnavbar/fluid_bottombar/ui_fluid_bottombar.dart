...
import './utils/fluid_nav_bar_icon.dart';
import './utils/fluid_nav_bar_item.dart';
...
///     UIProFluidNavBarIcon(iconPath: "assets/favorites.svg"),
///   ]
/// )
/// ```
/// {@end-tool}
...
class _UIProFluidNavBarState extends State<UIProFluidNavBar>
  ...
  Widget build(context) {
    ...
    const barHeight = UIProFluidNavBar.nominalHeight;
    // Extra space at top for the wave animation and selected icon pop-up
    ...
    return SizedBox(
      ...
      child: Stack(
        ...
        children: [
          // Background wave - positioned at the bottom
          Positioned(
            left: 0,
            top: topPadding,
            width: appSize.width,
          ...
          // Buttons - positioned to allow icons to pop up into topPadding area
          Positioned(
